export const SocialMediaButton = ({ name, icon = null, hoverStyle }) => {
    ...
    <div className="font-Roboto text-black">
      ...
      >
        ...
        >
          ...
          >
            <h4 className="z-10 flex w-full items-center justify-center gap-3 text-sm duration-200">
              {name}

              {icon !== null && <div className="w-7">{icon}</div>}
            </h4>
          </div>
        </button>
      </div>
